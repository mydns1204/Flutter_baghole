      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => ProductWidget(
            bag: params.getParam('bag', ParamType.String),
            price: params.getParam('price', ParamType.int),
            description: params.getParam('description', ParamType.String),
            pdname: params.getParam('pdname', ParamType.String),
            rating: params.getParam('rating', ParamType.int),
            piece: params.getParam('piece', ParamType.int),
          ),
        ),
        FFRoute(
          name: 'Home',
