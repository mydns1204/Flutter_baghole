          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(8.0, 24.0, 0.0, 40.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/LINE_ALBUM__230530_7.jpg',
                                      width: 100.0,
                                      height: 100.0,
                                      fit: BoxFit.contain,
                                    ),
                      ...
                      children: [
                        FutureBuilder<List<UserRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<UserRecord> sumPriceUserRecordList =
                                snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            }
                            final sumPriceUserRecord =
                                sumPriceUserRecordList.isNotEmpty
                                    ? sumPriceUserRecordList.first
                                    : null;
                            return Text(
                              formatNumber(
                                sumPriceUserRecord!.allCost,
                    ...
                    return FFButtonWidget(
                      onPressed: () async {
                        final userUpdateData = {
                          'all_cost': FieldValue.increment(-(valueOrDefault(
                              currentUserDocument?.allCost, 0))),
                        };
